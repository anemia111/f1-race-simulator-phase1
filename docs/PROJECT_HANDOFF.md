...
- Product: PC-first F1/SUPER FORMULA observer and race-control simulator.
...
- Fields: F1 11 teams/22 cars and SUPER FORMULA 16 teams/24 cars, backed by a
  110-person relational pool. Former F2/F3 fields are provenance-only history.
