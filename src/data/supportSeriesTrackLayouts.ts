...
export const supportSeriesTrackLayouts: Partial<Record<string, SupportTrackLayout>> = {
  "motegi-sf": {
    ...
    measuredKm: 4.812,
    sectorMarks: [0, 0.321, 0.692] as [number, number, number],
    source: {
  ...
  "autopolis-sf": {
    ...
    measuredKm: 4.633,
    sectorMarks: [0, 0.327, 0.673] as [number, number, number],
    source: {
      attribution: '© OpenStreetMap contributors (ODbL)',
      kind: 'openstreetmap',
  ...
  "fuji-sf": {
    ...
    measuredKm: 4.554,
    sectorMarks: [0, 0.372, 0.654] as [number, number, number],
    source: {
      attribution: '© OpenStreetMap contributors (ODbL)',
      kind: 'openstreetmap',
  ...
  "sugo-sf": {
    ...
    measuredKm: 3.581,
    sectorMarks: [0, 0.269, 0.635] as [number, number, number],
    source: {
      attribution: '© OpenStreetMap contributors (ODbL)',
      kind: 'openstreetmap',
