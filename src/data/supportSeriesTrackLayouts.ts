...
export const supportSeriesTrackLayouts: Partial<Record<string, SupportTrackLayout>> = {
  "motegi-sf": {
    ...
    measuredKm: 4.812,
    sectorMarks: [0, 0.365, 0.718] as [number, number, number],
    source: {
  ...
  "autopolis-sf": {
    ...
    measuredKm: 4.633,
    sectorMarks: [0, 0.378, 0.731] as [number, number, number],
    source: {
      attribution: '© OpenStreetMap contributors (ODbL)',
      kind: 'openstreetmap',
  ...
  "fuji-sf": {
    ...
    measuredKm: 4.554,
    sectorMarks: [0, 0.462, 0.756] as [number, number, number],
    source: {
      attribution: '© OpenStreetMap contributors (ODbL)',
      kind: 'openstreetmap',
  ...
  "sugo-sf": {
    ...
    measuredKm: 3.581,
    sectorMarks: [0, 0.34, 0.686] as [number, number, number],
    source: {
      attribution: '© OpenStreetMap contributors (ODbL)',
      kind: 'openstreetmap',
